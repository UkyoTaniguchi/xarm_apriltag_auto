...
def broadcast_transform():
    ...
    translation = (0.04891775551138969, -0.06085487498425083, 0.45706806730273297)
    raw_quat = (0.9963326936135536, -0.02934597411650787, -0.05829963421592267, -0.05532748042522279)
